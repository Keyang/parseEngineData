...
var paresr = function(engineData){
    ...
    }else if (currentNode.DocumentResources){

        return {
            EngineDict:currentNode.DocumentResources[0].EngineDict,
            ResourceDict:currentNode.DocumentResources[2],
            DocumentResources:currentNode
        };
    }
